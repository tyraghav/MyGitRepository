...
// Generated on: 2017.03.20 at 12:40:19 AM IST 
//
...
public class InputElement {
    ...
    @XmlElement(name = "In1", required = true)
    protected String in1;
    @XmlElement(name = "In2", required = true)
    protected String in2;
    @XmlElement(name = "In3", required = true)
    protected String in3;
    @XmlElement(name = "In4", required = true)
    protected String in4;
    @XmlElement(name = "In5", required = true)
